...
In Wox Inject there's a few concepts that you need to understand before jumping into Scopes, else you'll be flooded with unexpected behaviors. The first concept is the *Injectable Fragment*. This is the __thing__ that you want to resolve in your application. It can be a service, a controller, a view-model, or whatever design pattern satisfies your needs.
